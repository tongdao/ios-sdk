...
- (void)viewDidLoad {
    ...
    NSLog(@"the registrationId--------%@",registrationId);
//    NSLog(@"The registrationId is:%@", registrationId);

    
/******************************************************************************************************************/
    iWebView = [[UIWebView alloc] initWithFrame:CGRectMake(8, 8, self.view.bounds.size.width-16, 60)];
    ...
    [iWebView loadHTMLString:@"" baseURL:nil];
