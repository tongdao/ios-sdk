...
/**
 ...
 :returns: Bool 同道服务的初始化结果
 */
+(BOOL)initSdkWithSdk:(NSString*)appKey andDebugMode:(BOOL) debugMode;
...
/*
 ...
 :returns: Bool 同道服务的初始化结果
 */
+(BOOL)initSdkWithSdk:(NSString *)appKey andUserID:(NSString*)userId andDebugMode:(BOOL) debugMode;
...
/*
 ...
 :returns: Bool 同道服务的初始化结果
 */
+(BOOL)initSdkWithSdk:(NSString *)appKey andUserID:(NSString*)userId andIgnoreParam:(TongDaoinitData)ingnoreInfor andDebugMode:(BOOL) debugMode;
