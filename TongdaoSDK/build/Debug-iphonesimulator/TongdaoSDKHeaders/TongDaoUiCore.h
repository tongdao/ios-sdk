 ...
 *@return BOOL 同道服务的初始化结果
 */
//-(BOOL)initSdkWithAppKey:(NSString *)appKey andDebugMode:(BOOL) debugMode;
 ...
 *@return BOOL 同道服务的初始化结果
 */
//-(BOOL) initSdkWithAppKey:(NSString*) appKey andUserId:(NSString *) userId andDebugMode:(BOOL) debugMode;
 ...
 *@return BOOL 同道服务的初始化结果
 */
-(BOOL) initTDSdkWithTDAppKey:(NSString*) tdappKey userId:(NSString*)userId andDebugMode:(BOOL) debugMode;
